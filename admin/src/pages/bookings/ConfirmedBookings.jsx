  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="animate-pulse text-gray-500 text-lg">Loading confirmed bookings...</div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">
            All confirmed and active bookings ({confirmed.length} total)
          </p>
        </div>
                  ...
                  <tr>
                    <td colSpan="7" className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center space-y-3">
                        ...
                        <p className="text-gray-500 text-lg font-medium">No confirmed bookings found</p>
                        <p className="text-gray-400 text-sm">All bookings are either pending or completed.</p>
                      </div>
                    </td>
                  </tr>
                ) : (
        ...
        <div className="mt-8 text-center text-sm text-gray-500">
          Showing {confirmed.length} confirmed booking{confirmed.length !== 1 ? 's' : ''}
        </div>
      </div>
    </div>
  );
