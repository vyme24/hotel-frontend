  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="animate-pulse text-gray-500 text-lg">Loading refund requests...</div>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Manage and process refund requests ({refunds.length} total)
          </p>
        </div>
                  ...
                  <tr>
                    <td colSpan="6" className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center space-y-3">
                        ...
                        <p className="text-gray-500 text-lg font-medium">No refund requests found</p>
