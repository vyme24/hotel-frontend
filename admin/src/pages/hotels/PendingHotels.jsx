...
const PendingHotels = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="animate-pulse text-gray-500 text-lg">Loading pending hotels...</div>
      </div>
    );
  }
  ...
  const pendingHotels = data?.data?.filter((h) => h.status === "suspended") || [];
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Pending Hotels</h1>
            <p className="mt-2 text-sm text-gray-600">
              Hotels awaiting approval or activation ({pendingHotels.length} total)
            </p>
          </div>
          <Link
            to="/hotels"
                  ...
                  <tr>
                    <td colSpan="8" className="px-6 py-12 text-center">
                      <div className="flex flex-col items-center space-y-3">
                        ...
                        <p className="text-gray-500 text-lg font-medium">No pending hotels found</p>
                      </div>
                    </td>
                  </tr>
                ) : (
                  pendingHotels.map((h, index) => (
