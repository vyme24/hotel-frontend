...
const ActiveHotels = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Active Hotels</h1>
        <p className="text-sm text-gray-600">
          Total Active Hotels: {activeHotels.length}
        </p>
      </div>
              ...
              {activeHotels.length === 0 ? (
                ...
                activeHotels.map((h, index) => (
                  <tr key={h._id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <span className="inline-flex px-3.5 py-1.5 rounded-full text-xs font-medium bg-green-200 text-green-800">
                        Active
                      </span>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <Link
                        to={`/hotels/${h._id}`}
                        className="px-3 py-2 rounded-md text-white bg-green-700 "
                      >
                        View
                      </Link>
                    </td>
